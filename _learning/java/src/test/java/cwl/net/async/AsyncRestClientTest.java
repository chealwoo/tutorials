...
public class AsyncRestClientTest {
    ...
    public void testGetDataStringAsync() throws Exception {
        ...
        this.mockServer.expect(MockRestRequestMatchers.requestTo(apiUrl)).andExpect(MockRestRequestMatchers.method(HttpMethod.GET)).andRespond(MockRestResponseCreators.withSuccess(mockResponseBody, MediaType.APPLICATION_JSON));
