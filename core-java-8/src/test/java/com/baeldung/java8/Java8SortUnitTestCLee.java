...
public class Java8SortUnitTestCLee {
    ...
    @Test
    public final void givenLambdaShortForm_whenSortingEntitiesByName_thenCorrectlySorted2() {
        final List<Human> humans = Lists.newArrayList(new Human("Sarah", 10), new Human("Jack", 12));
    ...
    public final void whenSortingEntitiesByNameThenAge_thenCorrectlySorted() {
        ...
        humans.sort(Java8SortUnitTestCLee::compareByNameThenAge);
